    ...
    >
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        <button
          ...
          style={{ background: "none", border: "none", color: "var(--text-muted)", fontSize: "0.9rem", fontWeight: "700", cursor: "pointer" }}
        >
          Skip
        </button>
      </div>
      ...
      <div style={{ textAlign: "center", margin: "10px 0" }}>
        ...
        >
          <svg width="68" height="68" viewBox="0 0 24 24" fill="none" stroke="#38BDF8" strokeWidth="2">
            <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
            <path d="m9 12 2 2 4-4" />
          </svg>
          <span style={{ fontSize: "0.78rem", fontWeight: "800", letterSpacing: "0.08em", color: "#38BDF8", fontFamily: "Poppins, sans-serif" }}>
            PRE-TRANSACTION SAFETY
          </span>
        </div>

        <h2 style={{ fontSize: "1.65rem", fontWeight: "800", marginBottom: "10px", fontFamily: "Poppins, sans-serif" }}>
          Pay Safely. Scan Smart.
        </h2>
        <p style={{ color: "var(--text-secondary)", fontSize: "0.92rem", lineHeight: "1.5", marginBottom: "20px" }}>
          Protect yourself from fake QR code stickers placed over shop payments before money leaves your account.
        </p>

        {/* Highlight Feature Card */}
        <div style={{ textAlign: "left", background: "var(--bg-card)", padding: "16px 18px", borderRadius: "20px", border: "1px solid var(--bg-card-border)", boxShadow: "var(--card-shadow)" }}>
          <div style={{ fontSize: "0.84rem", color: "#10B981", fontWeight: "700", marginBottom: "10px", display: "flex", alignItems: "center", gap: "8px" }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><polyline points="20 6 9 17 4 12"/></svg>
            Pre-Transaction Shield
          </div>
          <div style={{ fontSize: "0.82rem", color: "var(--text-main)", display: "flex", flexDirection: "column", gap: "8px", fontWeight: "600" }}>
            <div>🛡️ Verified payment destination handles</div>
            <div>🧠 Sentinel Memory™ geofence location baselines</div>
            <div>⚡ Sub-10ms real-time serverless AI evaluation</div>
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center", margin: "10px 0" }}>
        ...
        >
          <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#C084FC" strokeWidth="2.2">
          ...
          <span style={{ fontSize: "0.78rem", fontWeight: "800", letterSpacing: "0.08em", color: "#E9D5FF", fontFamily: "Poppins, sans-serif" }}>
            XAI REASONING ENGINE
          </span>
        </div>

        <h2 style={{ fontSize: "1.65rem", fontWeight: "800", marginBottom: "14px", fontFamily: "Poppins, sans-serif" }}>
        ...
        <div style={{ textAlign: "left", background: "var(--bg-card)", padding: "18px", borderRadius: "20px", border: "1px solid var(--bg-card-border)", boxShadow: "var(--card-shadow)" }}>
          <div style={{ fontSize: "0.88rem", color: "#EF4444", fontWeight: "800", marginBottom: "12px", display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <div style={{ fontSize: "0.84rem", color: "var(--text-main)", display: "flex", flexDirection: "column", gap: "10px", fontWeight: "600" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <span style={{ width: "8px", height: "8px", borderRadius: "50%", background: "#38BDF8", flexShrink: 0 }} />
              Physical QR sticker tampering at shop stands
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div style={{ textAlign: "center", marginTop: "8px" }}>
        <h2 style={{ fontSize: "1.55rem", fontWeight: "800", marginBottom: "6px", fontFamily: "Poppins, sans-serif" }}>
